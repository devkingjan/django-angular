...
default_settings = {
    ...
    'SET_PIN_RETYPE': False,
    'SET_USERNAME_RETYPE': False,
    'PASSWORD_RESET_CONFIRM_RETYPE': False,
    'PIN_RESET_CONFIRM_RETYPE': False,
    'PASSWORD_RESET_SHOW_EMAIL_NOT_FOUND': False,
    'PIN_RESET_SHOW_EMAIL_NOT_FOUND': False,
    'PASSWORD_VALIDATORS': [],
    ...
    'SERIALIZERS': ObjDict({
        ...
        'set_pin':
            'authentication.serializers.SetPinSerializer',
        'set_pin_retype':
            'authentication.serializers.SetPinRetypeSerializer',
        'pin_reset':
            'authentication.serializers.PinResetSerializer',
        'pin_reset_confirm':
            'authentication.serializers.PinResetConfirmSerializer',
        'pin_reset_confirm_retype':
            'authentication.serializers.PinResetConfirmRetypeSerializer',
        'set_username':
    ...
    'EMAIL': ObjDict({
        ...
        'pin_reset': 'authentication.email.PinResetEmail',
    }),
