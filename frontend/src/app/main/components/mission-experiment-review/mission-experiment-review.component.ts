...
@Component({
    selector: 'app-mission-experiment-review',
    templateUrl: './mission-experiment-review.component.html',
    styleUrls: ['./mission-experiment-review.component.scss']
})
export class MissionExperimentReviewComponent implements OnInit {
    expanded = true;
    experiments: any[] = [];
    getResponse = false;
